...
import upwork.ionic.test.domain.Book;
import upwork.ionic.test.domain.Author;
import upwork.ionic.test.repository.BookRepository;
import upwork.ionic.test.service.BookService;
...
import static upwork.ionic.test.web.rest.TestUtil.createFormattingConversionService;
