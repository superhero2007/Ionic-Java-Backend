package upwork.ionic.test.web.rest;

import upwork.ionic.test.IonicTestApp;
import upwork.ionic.test.config.Constants;
import upwork.ionic.test.domain.Authority;
import upwork.ionic.test.domain.User;
import upwork.ionic.test.repository.AuthorityRepository;
import upwork.ionic.test.repository.UserRepository;
import upwork.ionic.test.security.AuthoritiesConstants;
import upwork.ionic.test.service.MailService;
import upwork.ionic.test.service.UserService;
import upwork.ionic.test.service.dto.PasswordChangeDTO;
import upwork.ionic.test.service.dto.UserDTO;
import upwork.ionic.test.web.rest.errors.ExceptionTranslator;
import upwork.ionic.test.web.rest.vm.KeyAndPasswordVM;
import upwork.ionic.test.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = IonicTestApp.class)
